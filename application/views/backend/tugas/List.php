                ...
                <tbody>
                  <?php foreach ($list as $item) { ?>
                    <tr>
                      ...
                      <td>
                        <div class="d-flex">
                          <button onclick="location.href='<?= site_url('backend/tugas/cetak?id=' . $item->id_tugas); ?>'" class="btn-raised btn-success  btn-sm waves-effect">Cetak</button>
                          <button onclick="location.href='<?= site_url('backend/tugas/edit?id=' . $item->id_tugas); ?>'" class="btn-raised btn-info  btn-sm waves-effect">Edit</button>
                          <button class="btn-raised btn-danger btn-sm" data-type="tugas" id="<?= $item->id_tugas ?>">Hapus Data</buton>
                        </div>
                      </td>
                    </tr>
                  <?php } ?>
