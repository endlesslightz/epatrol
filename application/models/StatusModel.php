...
// ========================== function =======================//
    ...
    function get_status(){
      $query=$this->db->query("SELECT * FROM `presensi` t1 INNER JOIN (SELECT MAX(wkt_masuk) masuk FROM presensi GROUP BY id_petugas) t2 ON t1.wkt_masuk=t2.masuk INNER JOIN petugas USING (id_petugas) GROUP BY id_petugas ");
      return $query->result();
    }
